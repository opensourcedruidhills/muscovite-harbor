...
# llvm-cov coverage targets for MuscoviteHarbor / HarbourControl

# Aggregate: merge all profraw data and produce summary report
add_custom_target(coverage-llvm-harbour_control
    ...
    COMMAND llvm-cov show ${CMAKE_BINARY_DIR}/$<TARGET_FILE_NAME:${PROJECT_NAME}_tests>
            -instr-profile=${CMAKE_BINARY_DIR}/profiles/merged.profdata
            -format=html -output-dir=${CMAKE_BINARY_DIR}/coverage-html/harbour_control
    COMMENT "Generating llvm-cov report for context HarbourControl"
)
