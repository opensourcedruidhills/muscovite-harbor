...
ALTER TABLE boarding_passes ADD CONSTRAINT fk_boarding_passes_passenger_id FOREIGN KEY (passenger_id) REFERENCES passenger_terminal.passengers (id);
ALTER TABLE boarding_passes ADD CONSTRAINT fk_boarding_passes_gate_id FOREIGN KEY (gate_id) REFERENCES passenger_terminal.gates (id);
