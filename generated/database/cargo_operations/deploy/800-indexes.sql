...
CREATE INDEX IF NOT EXISTS idx_reefer_units_reefer_unit_id ON reefer_units (container_id);
CREATE INDEX IF NOT EXISTS idx_discharge_sequences_discharge_sequence_id ON discharge_sequences (load_plan_id);
