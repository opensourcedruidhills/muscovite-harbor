...
// Value object immutability tests for CargoOperations

SCENARIO("Value object immutability: ContainerDimensions") {
    GIVEN("a ContainerDimensions value object") {
        auto rng = std::mt19937{std::random_device{}()};
        auto dist = std::uniform_int_distribution<int>{0, 10000};
        auto uuid_gen = boost::uuids::random_generator{};
        auto vo = ContainerDimensions{};
