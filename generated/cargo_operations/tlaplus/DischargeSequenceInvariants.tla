---- MODULE DischargeSequenceInvariants ----
EXTENDS Naturals, Sequences, FiniteSets

\* Aggregate consistency invariants for DischargeSequence
...
\* ── Domain sets ──────────────────────────────────────────────
EmittedEvents == {"ContainerPlaced", "ContainerPicked"}
Commands == {"PlaceContainer", "PickContainer"}
Fields == {"id", "load_plan_id", "container_id", "sequence_order", "crane_id"}
AllEvents == {}
