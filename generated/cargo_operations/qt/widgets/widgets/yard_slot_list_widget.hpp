...
class YardSlotListWidget : public QWidget {
    Q_OBJECT
public:
    explicit YardSlotListWidget(QWidget* parent = nullptr);

    [[nodiscard]] auto model() -> YardSlotModel* { return model_; }
