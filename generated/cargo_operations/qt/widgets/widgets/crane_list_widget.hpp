...
class CraneListWidget : public QWidget {
    Q_OBJECT
public:
    explicit CraneListWidget(QWidget* parent = nullptr);

    [[nodiscard]] auto model() -> CraneModel* { return model_; }
