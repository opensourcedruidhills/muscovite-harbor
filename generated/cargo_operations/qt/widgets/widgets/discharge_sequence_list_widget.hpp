...
class DischargeSequenceListWidget : public QWidget {
    Q_OBJECT
public:
    explicit DischargeSequenceListWidget(QWidget* parent = nullptr);

    [[nodiscard]] auto model() -> DischargeSequenceModel* { return model_; }
