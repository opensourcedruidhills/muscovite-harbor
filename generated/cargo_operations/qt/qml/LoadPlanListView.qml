...
Page {
    ...
    Accessible.name: qsTr("LoadPlans list")
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            TextField {
                id: searchField
                placeholderText: qsTr("Search LoadPlan...")
                Layout.fillWidth: true
                Accessible.name: qsTr("Search LoadPlan")
                onTextChanged: {
        ...
        BusyIndicator {
            ...
            Accessible.name: qsTr("Loading LoadPlan...")
        }
        ...
        ListView {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: RowLayout {
                    ...
                    Label { text: model.createdAt || ""; Layout.fillWidth: true }
            ...
            ColumnLayout {
                ...
                Label {
                    Layout.alignment: Qt.AlignHCenter
                    text: qsTr("No LoadPlan items found")
                    font.pixelSize: 16
                }

                Button {
                    Layout.alignment: Qt.AlignHCenter
                    text: qsTr("Create First LoadPlan")
                    Accessible.name: qsTr("Create the first LoadPlan")
