...
class PilotAssignmentModel : public QAbstractTableModel {
    Q_OBJECT
public:
    enum Column {
        Id,
    ...
    explicit PilotAssignmentModel(QObject* parent = nullptr);
    ...
    struct Row {
        ...
        QString pilot_name;
        QString pilot_zone;
        QDateTime boarding_time;
        QDateTime disembark_time;
    };
