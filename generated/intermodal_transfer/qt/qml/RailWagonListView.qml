...
Page {
    ...
    Accessible.name: qsTr("RailWagons list")
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            TextField {
                id: searchField
                placeholderText: qsTr("Search RailWagon...")
                Layout.fillWidth: true
                Accessible.name: qsTr("Search RailWagon")
                onTextChanged: {
        ...
        BusyIndicator {
            ...
            Accessible.name: qsTr("Loading RailWagon...")
        }
        ...
        ListView {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: RowLayout {
                    ...
                    Label { text: model.wagonNumber || ""; Layout.fillWidth: true }
            ...
            ColumnLayout {
                ...
                Label {
                    Layout.alignment: Qt.AlignHCenter
                    text: qsTr("No RailWagon items found")
                    font.pixelSize: 16
                }

                Button {
                    Layout.alignment: Qt.AlignHCenter
                    text: qsTr("Create First RailWagon")
                    Accessible.name: qsTr("Create the first RailWagon")
