...
class RailWagonListWidget : public QWidget {
    Q_OBJECT
public:
    explicit RailWagonListWidget(QWidget* parent = nullptr);

    [[nodiscard]] auto model() -> RailWagonModel* { return model_; }
