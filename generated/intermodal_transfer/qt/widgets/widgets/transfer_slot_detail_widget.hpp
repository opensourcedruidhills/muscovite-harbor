...
class TransferSlotDetailWidget : public QWidget {
    Q_OBJECT
public:
    explicit TransferSlotDetailWidget(QWidget* parent = nullptr);
...
private:
    ...
    QLabel* reference_value_ = nullptr;
    QLabel* container_id_value_ = nullptr;
    QLabel* transport_mode_value_ = nullptr;
    QLabel* scheduled_at_value_ = nullptr;
