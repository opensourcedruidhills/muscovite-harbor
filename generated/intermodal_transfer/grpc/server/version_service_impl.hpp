...
#include "intermodal_transfer/intermodal_transfer_version.grpc.pb.h"
#include "intermodal_transfer/intermodal_transfer_version.pb.h"
...
class VersionServiceImpl final : public intermodaltransfer::VersionService::Service {
public:
    ::grpc::Status GetVersion(
            ::grpc::ServerContext* /*context*/, const intermodaltransfer::VersionRequest* /*request*/,
            intermodaltransfer::VersionResponse* response) override {
