...
// Relationship integrity tests for IntermodalTransfer

SCENARIO("Relationship integrity: TruckVisit -> TransferSlot via TruckVisit") {
    GIVEN("a TruckVisit referencing a TransferSlot") {
