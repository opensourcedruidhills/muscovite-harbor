...
// Value object immutability tests for PassengerTerminal

SCENARIO("Value object immutability: PassengerName") {
    GIVEN("a PassengerName value object") {
        auto rng = std::mt19937{std::random_device{}()};
        auto dist = std::uniform_int_distribution<int>{0, 10000};
        auto uuid_gen = boost::uuids::random_generator{};
        auto vo = PassengerName{};
