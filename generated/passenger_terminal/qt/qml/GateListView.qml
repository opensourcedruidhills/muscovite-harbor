...
Page {
    ...
    Accessible.name: qsTr("Gates list")
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            TextField {
                id: searchField
                placeholderText: qsTr("Search Gate...")
                Layout.fillWidth: true
                Accessible.name: qsTr("Search Gate")
                onTextChanged: {
        ...
        BusyIndicator {
            ...
            Accessible.name: qsTr("Loading Gate...")
        }
        ...
        ListView {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: RowLayout {
                    ...
                    Label { text: model.capacity || ""; Layout.fillWidth: true }
            ...
            ColumnLayout {
                ...
                Label {
                    Layout.alignment: Qt.AlignHCenter
                    text: qsTr("No Gate items found")
                    font.pixelSize: 16
                }

                Button {
                    Layout.alignment: Qt.AlignHCenter
                    text: qsTr("Create First Gate")
                    Accessible.name: qsTr("Create the first Gate")
