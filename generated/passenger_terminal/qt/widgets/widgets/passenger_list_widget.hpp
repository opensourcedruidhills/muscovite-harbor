...
class PassengerListWidget : public QWidget {
    Q_OBJECT
public:
    explicit PassengerListWidget(QWidget* parent = nullptr);

    [[nodiscard]] auto model() -> PassengerModel* { return model_; }
