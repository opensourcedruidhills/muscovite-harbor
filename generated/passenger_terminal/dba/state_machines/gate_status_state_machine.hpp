...
/// Compile-time state ID constants for GateStatus.
namespace gate_status_states {
    inline constexpr auto CLOSED = "CLOSED";
    inline constexpr auto CHECK_IN_OPEN = "CHECK_IN_OPEN";
    inline constexpr auto BOARDING = "BOARDING";
    inline constexpr auto FINAL_CALL = "FINAL_CALL";
} // namespace gate_status_states
...
/// State machine for Gate entity lifecycle.
class GateStatusStateMachine {
public:
