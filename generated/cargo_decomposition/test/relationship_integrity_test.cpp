...
// Relationship integrity tests for CargoDecomposition

SCENARIO("Relationship integrity: Parcel -> Pallet via Parcel") {
    GIVEN("a Parcel referencing a Pallet") {
...
SCENARIO("Relationship integrity: DeliveryUnit -> Parcel via DeliveryUnit") {
    GIVEN("a DeliveryUnit referencing a Parcel") {
        auto rng = std::mt19937{std::random_device{}()};
        auto dist = std::uniform_int_distribution<int>{0, 10000};
        auto uuid_gen = boost::uuids::random_generator{};
        auto source_id = boost::uuids::to_string(uuid_gen());
