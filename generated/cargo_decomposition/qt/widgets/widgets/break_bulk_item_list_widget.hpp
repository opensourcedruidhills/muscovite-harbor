...
class BreakBulkItemListWidget : public QWidget {
    Q_OBJECT
public:
    explicit BreakBulkItemListWidget(QWidget* parent = nullptr);

    [[nodiscard]] auto model() -> BreakBulkItemModel* { return model_; }
