...
class ParcelListWidget : public QWidget {
    Q_OBJECT
public:
    explicit ParcelListWidget(QWidget* parent = nullptr);

    [[nodiscard]] auto model() -> ParcelModel* { return model_; }
